  ...
  return (
    <div style={{ position: 'relative', width: size, height: size, flexShrink: 0 }}>
      <svg width={size} height={size} viewBox="0 0 100 100">
        ...
        <circle cx={50} cy={50} r={38} fill="none" stroke="#E8412C" strokeWidth={1.5} strokeDasharray="3,3" />
        ...
        <text x={50} y={66} textAnchor="middle" style={{ fontFamily: "'Quicksand',sans-serif", fontSize: 32, fontWeight: 700, fill: '#E8412C' }}>
          {level}
        </text>
      </svg>
    </div>

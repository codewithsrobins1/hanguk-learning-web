...
Give the meaning of that word/phrase AS USED in this specific sentence — if it's a conjugated verb or has a particle attached, give the core meaning in context rather than a dictionary headword. This is displayed inline as "word — definition" in a compact list, so keep it VERY short: for a single word, 1-4 words; for a multi-word phrase, a short natural gloss (up to ~8 words) rather than a full sentence. No Korean in the response, no trailing period.

Examples of the target length: "I" · "friend" · "went (past tense)" · "at, in (location)" · "really, very" · "drinking coffee, and" (for a chained phrase like "커피를 마시고").
